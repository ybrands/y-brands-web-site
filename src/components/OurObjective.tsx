            ...
            <div id="OurObjective">
                ...
                <div className="hidden w-screen lg:flex flex-row px-20 py-5 ">
                    <div className="flex flex-row">
                        ...
                        <div className='w-3/5 flex flex-col justify-center items-center'>
                            <img className="w-5/6" src="/assets/OurObjective.svg" />
                        </div>
                    </div>
                </div>
                ...
                <div className="w-screen flex flex-col lg:hidden pt-5 px-10">
                    ...
                    <div className='flex flex-col items-center pt-5'>
                        <img className="w-full" src="/assets/OurObjectiveFirstMobile.svg" />
                    ...
                    <div className='pt-5 flex flex-col justify-start row-span-2 col-span-2'>
                        <img className="max-w-1/2" src="/assets/OurObjectiveSecondMobile.svg" />
                    </div>
                </div>
            </div>
        </>
